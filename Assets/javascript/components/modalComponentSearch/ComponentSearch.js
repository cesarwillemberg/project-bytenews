class ModalComponentSearch extends HTMLElement {
    ...
    createResultSearch() {
        ...
        for (let i = 0; i <= 3; i++) {
            ...
            resultSearchComponent.setAttribute('data-title', `Título Exemplo ${i + 1}`);
            resultSearchComponent.setAttribute('data-img', '/Assets/imgs/h1.png');
            resultSearchComponent.setAttribute('data-subtitle', 'Notícia');
            resultSearchComponent.setAttribute('data-item-subtitle-text', `<i class="fa-regular fa-newspaper"></i>`);
            resultSearchComponent.setAttribute('data-description', `Descrição exemplo ${i + 1}.`);
